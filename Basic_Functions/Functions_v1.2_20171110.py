...
@file: Functions_v1.2_20171110.py
@time: 2017/11/04 11:39
"""
# coding: utf-8
"""
====
...
def import_index_data_wande(index_code='000001.SH', input_data_path=input_data_path + index_dir_wande, start_date='19890101'):
    ...
    :param input_data_path = 'D:/all_trading_data/data/input_data/index_data_wande/' 万得个股数据路径
...
# 4.1 获得万得的股票代码列表
def get_stock_code_list_in_one_dir_wande(input_data_path=input_data_path + stock_dir_wande):
    """
    指定文件夹下找到所有股票代码
    :param path: 指定文件夹路径
...
# 4.2 获得xbx的股票代码列表
def get_stock_code_list_in_one_dir_xbx(input_data_path=input_data_path + stock_dir_xbx):
    """
    指定文件夹下找到所有股票代码
    :param path: 指定文件夹路径
    :return: 返回stock code list
